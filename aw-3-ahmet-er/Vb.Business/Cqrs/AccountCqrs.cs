...
public record GetAccountByParameterQuery(string IBAN, decimal MinBalance, decimal MaxBalance, string CurrentType, string Name, DateTime MinOpenDate, DateTime MaxOpenDate) : IRequest<ApiResponse<List<AccountResponse>>>;